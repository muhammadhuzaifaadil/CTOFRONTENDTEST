...
import { Box, CircularProgress, Button, Container, Typography, Divider, TextField,useTheme } from "@mui/material";
  ...
  >
    ...
    <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", width: "100%", mt: 2 }}>
      <Button
        ...
        sx={{ color: "white", backgroundColor: theme.palette.primary.main, width: "100%", borderRadius: 3, py: 1.1 }}
      >
        {t("EditProfileButton")}
      </Button>
    </Box>
