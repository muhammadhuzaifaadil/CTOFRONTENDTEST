...
interface AddAdminDialogProps {
  open: boolean;
  onClose: () => void;
  onSave?: (values: AddAdminFormValues) => void | Promise<void>;
}
...
// --- Role ---
  ...
  const handleSave = () => {
    const values: AddAdminFormValues = {
      role,
      user: {
        firstName,
        middleName,
    ...
    >
      <DialogTitle sx={{ pb: 1 }}>
        ...
        <Typography variant="body2" color="text.secondary" component="p">
          Register a new admin. Fields marked with * are required.
        </Typography>
      </DialogTitle>
      ...
      <DialogContent dividers sx={{ pt: 2 }}>
        ...
        <FormControlLabel
          ...
          label="I confirm that the admin accepts the platform terms and conditions"
          sx={{ mb: 0 }}
        />
      </DialogContent>
